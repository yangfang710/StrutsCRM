...
<HTML>
	...
	<body>
	    <s:form action="department_add" namespace="/" enctype="multipart/form-data" theme="simple">
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>添加部门</STRONG>
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:textfield name="deptName" cssClass="bg"></s:textfield>
					</td>
				</tr>
				<tr >
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">选择地址：</td>
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<div>
				...
				<tr >
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield id="address" name="address" cssClass="bg"></s:textfield>
					</td>
				</tr>
				<TR>
