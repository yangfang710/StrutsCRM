	...
	<HEAD>
		...
		<script type="text/javascript">
			function addDepartment(){
				window.location.href = "<c:url value='/department/add.jsp'/>";
			}
		</script>
	</HEAD>
	<body>
		<br>
		<s:form action="department_list" namespace="/" theme="simple">
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:textfield name="deptName" size="15" cssClass="bg"></s:textfield>
									</td>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
										地址：
									</td>
