...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="<c:url value='/user/address.js'/>"></script>
	</HEAD>
	...
	<body>
	    <s:form action="user_add" namespace="/" enctype="multipart/form-data" theme="simple">
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:password name="loginpass" cssClass="bg"></s:password>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						用户姓名：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select list="{'男','女'}" name="gender"></s:select>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						学历：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:checkboxlist name="hobby" list="{'看电影','看书','旅游','健身','购物','睡觉'}" />
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						毕业去向：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="fulture" />
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<div>
					        ...
					        <s:textfield id="address" name="address" readonly="true" cssStyle="WIDTH: 400px;" />
					    </div>
					  </td>
				</tr>
				<tr>
